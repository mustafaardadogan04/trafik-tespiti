...
Model iki farklı veri setinin birleşimiyle eğitildi (~18k görüntü, çok açılı):

- [Traffic Detection Project](https://www.kaggle.com/datasets/yusufberksardoan/traffic-detection-project) — sokak/CCTV açısı, YOLO formatında (Kaggle)
...
Birleşik set, repodaki dönüştürme scriptleriyle iki kaynaktan üretilir.
